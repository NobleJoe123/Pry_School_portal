    ...
    test('useQuery hook sets isFetching=true whenever a request is in flight', async () => {
      function User() {
        ...
        return (
          <div>
            <div data-testid="isFetching">{String(isFetching)}</div>
            <button onClick={() => setValue((val) => val + 1)} aria-label="Increment value">
              Increment value
            </button>
          </div>
        )
      ...
      function User() {
        ...
        return (
          <div>
            ...
            <div data-testid="isFetching">{String(isFetching)}</div>
            <button data-testid="fetchButton" onClick={() => fetchTest(i++)} aria-label="Fetch user">
              fetchUser
            </button>
          </div>
        )
