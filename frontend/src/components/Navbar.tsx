        ...
        <header className="sticky top-0 z-30 flex items-center justify-between px-6 py-3.5 border-b border-white/5 backdrop-blur-sm"
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative hidden md:block">
                    ...
                    <input type="text" placeholder="Search students, teachers..." className="pl-9 pr-4 py-2 bg-white/5 border border-white/10 rounded-xl text-slate-300 text-sm placeholder-slate-600 focus:outline-none focus:border-sky-500/40 focus:bg-white/8 transition-all w-56" />

                </div>

                {/* Notifications */}
                <button type="button" title="Notifications" className="relative p-2 rounded-xl bg-white/5 border border-white/10 text-slate-400 hover:text-white hover:bg-white/10 transition-all">
                    <Bell size={16} />
