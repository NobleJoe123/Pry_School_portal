...
export default function Students() {
    ...
    return (
        <div className="space-y-5 max-w-screen-xl">
                        ...
                        <div
                            ...
                            className={`rounded-2xl p-4 border cursor-pointer flex flex-col justify-between gap-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg group ${
                                isActive
                                    ...
                                    : 'border-white/5 hover:border-sky-500/20 hover:shadow-sky-500/5 bg-[#0b1523]'
                            }`}
                        >
                            <div className="flex items-start justify-between">
                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                                    isActive ? 'bg-sky-500/20 text-sky-300' : 'bg-sky-500/10 text-sky-400 group-hover:bg-sky-500/20 group-hover:text-sky-300'
                                }`}>
                                    <GraduationCap size={20} />
                                </div>
                                <span className={`text-[10px] font-bold px-2 py-1 rounded-full transition-all ${
                                    isActive ? 'text-sky-300 bg-sky-500/20' : 'text-sky-400 bg-sky-500/10'
                                }`}>
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 text-[10px] mt-1 truncate">
                                    Teacher: <span className="text-slate-300 font-semibold">{teacherName}</span>
                                </p>
                            </div>
                        </div>
                    );
            ...
            {/* List Details Title / Class Teacher Info */}
            <div className="flex items-center justify-between flex-wrap gap-4 mt-2">
                <div>
                    <h3 className="text-white text-lg font-bold">Students in {selectedClass}</h3>
