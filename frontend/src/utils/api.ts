...
export const endpoints = {
    ...
    finance: {
        ...
        paymentsPending: '/finance/payments/?confirmed=false&is_rejected=false',
        paymentsRejected: '/finance/payments/?is_rejected=true',
        paymentDetail: (id: string) => `/finance/payments/${id}/`,
        confirmPayment: (id: string) => `/finance/payments/${id}/confirm_payment/`,
        rejectPayment: (id: string) => `/finance/payments/${id}/reject_payment/`,
